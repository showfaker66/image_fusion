...
def Images_fusion(img_base,img_target):
    ...
    print("小波逆变换时间为：", time.time() - start2)
...
def main():
    start1 = time.time()
    matchimg_di = cv2.imread('images/oripics/basic_day_infrared.jpg')
    ...
    print("图像配准时间为：", time.time() - start2)
